 ...
 * @since 1.0-SNAPSHOT
 */
public class MySQLFactoryImpl implements MySQLFactory {

    public static MySQLFactoryImpl create() {return new MySQLFactoryImpl();}

    private MySQLFactoryImpl() {}

    @Override
    public boolean createMySQL(String name, String host, String port, String username, String password, String database, boolean connectByStart) {
